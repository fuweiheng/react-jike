          ...
          <div className="user-info">
            ...
            <div className="user-menu">
              ...
              {isVisibleMenu && <div class="drop-down-menu light-shadow">
                ...
                <svg  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class=""><circle  cx="10.0004" cy="5.46816" r="3.62539" stroke="currentColor" stroke-width="1.2"></circle><path  d="M12.176 11.8125H7.82554C5.0224 11.8125 2.75 14.0849 2.75 16.888C2.75 17.5888 3.3181 18.1569 4.01889 18.1569H15.9827C16.6834 18.1569 17.2515 17.5888 17.2515 16.888C17.2515 14.0849 14.9792 11.8125 12.176 11.8125Z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"></path></svg>
                </span>
                ...
                <svg  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class=""><rect  x="3.46094" y="2.13086" width="13.0967" height="15.7249" rx="1.5" stroke="#8A919F" stroke-width="1.2"></rect><path  d="M7.45052 10.8334C7.45722 10.6305 7.54084 10.4377 7.68441 10.2941L10.8488 7.12981C11.2394 6.7393 11.8725 6.73931 12.263 7.12983L13.0134 7.88015C13.4039 8.27068 13.4039 8.90385 13.0134 9.29438L9.84893 12.4587C9.70537 12.6022 9.5126 12.6858 9.30968 12.6925L8.02763 12.7349C7.68085 12.7464 7.39667 12.4622 7.40813 12.1154L7.45052 10.8334Z" stroke="#8A919F" stroke-width="1.2"></path><path  d="M2.30859 6.14648H4.61629" stroke="#8A919F" stroke-width="1.2" stroke-linecap="round"></path><path  d="M2.30859 9.99219H4.61629" stroke="#8A919F" stroke-width="1.2" stroke-linecap="round"></path><path  d="M2.30859 13.8389H4.61629" stroke="#8A919F" stroke-width="1.2" stroke-linecap="round"></path></svg>
                </span>
                ...
                <span class="menu-icon menu-icon-light">
                <svg  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class=""><path  d="M8.48696 16.866L11.7141 16.866L18.5 7.5181L15.7187 5.10263L10.0447 12.6364L4.27982 5.10263L1.55487 7.5181L8.48696 16.866Z" stroke="#8A919F" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path><path  d="M6.5625 3.06445L10 7.54883L13.4062 3.06445" stroke="#8A919F" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                </span>
                ...
                <span class="menu-icon menu-icon-light">
                <svg  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class=""><path  d="M4.62218 2.68165C3.64897 2.29236 2.59033 3.0091 2.59033 4.05728V13.961C2.59033 14.2639 2.77476 14.5363 3.05601 14.6488L8.88416 16.98C9.59939 17.2661 10.3973 17.2661 11.1125 16.98L16.9406 14.6488C17.2219 14.5363 17.4063 14.2639 17.4063 13.961V4.05728C17.4063 3.0091 16.3477 2.29236 15.3745 2.68165L11.1125 4.38644C10.3973 4.67253 9.59939 4.67253 8.88416 4.38644L4.62218 2.68165Z" stroke="currentColor" stroke-width="1.2"></path><path  d="M9.99609 7.42676V14.094" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"></path></svg>
                </span> 
                ...
                <span  class="menu-icon menu-icon-light">
                <svg  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class=""><path  d="M12.7008 10.75L12.7008 13.1692C12.7008 14.3564 13.6632 15.3188 14.8504 15.3188V15.3188C16.0376 15.3188 17 14.3564 17 13.1692L17 10.75" stroke="#8A919F" stroke-width="1.2"></path><path  d="M11.3201 5.39275C11.3201 3.50114 12.7118 1.89774 14.5846 1.6317V1.6317C14.7618 1.60653 14.9417 1.60653 15.1189 1.6317V1.6317C16.9917 1.89774 18.3834 3.50114 18.3834 5.39275V9.67128C18.3834 10.4747 17.7321 11.126 16.9287 11.126H12.7747C11.9714 11.126 11.3201 10.4747 11.3201 9.67128V5.39275Z" stroke="#8A919F" stroke-width="1.2"></path><path  d="M11.3203 8.14209H18.3834" stroke="#8A919F" stroke-width="1.2"></path><path  d="M3.01326 14L3.01326 16.4192C3.01326 17.6064 3.97568 18.5688 5.16288 18.5688V18.5688C6.35008 18.5688 7.3125 17.6064 7.3125 16.4192L7.3125 14" stroke="#8A919F" stroke-width="1.2"></path><path  d="M1.63257 8.64275C1.63257 6.75114 3.02429 5.14774 4.8971 4.8817V4.8817C5.0743 4.85653 5.25417 4.85653 5.43138 4.8817V4.8817C7.30419 5.14774 8.6959 6.75114 8.6959 8.64275V12.9213C8.6959 13.7247 8.04462 14.376 7.24122 14.376H3.08725C2.28385 14.376 1.63257 13.7247 1.63257 12.9213V8.64275Z" stroke="#8A919F" stroke-width="1.2"></path><path  d="M1.63281 11.3921H8.69586" stroke="#8A919F" stroke-width="1.2"></path></svg>
                </span>
